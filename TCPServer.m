...
- (BOOL)start:(NSError **)error {
    ...
    if (nil != type) {
		...
		NSDictionary *txtDictionary = [NSDictionary dictionaryWithObjectsAndKeys:@"AppleTV2,1", @"model", @"94:0C:6D:E6:80:56", @"deviceid", @"0x77", @"features", @"1.0", @"protovers", @"101.10", @"srcvers", nil];
...
- (void)netService:(NSNetService *)sender didNotPublish:(NSDictionary *)errorDict {
	NSLog(@"Did not publish.\nError Code: %@\nError Domain: %@", [errorDict objectForKey:NSNetServicesErrorCode], [errorDict objectForKey:NSNetServicesErrorDomain]);
}
